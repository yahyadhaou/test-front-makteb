...
function AddNewfolderPage() {
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.post('https://test-al-makteb.onrender.com/InsertFolderData', formData);
    ...
    <>
      ...
      <Card item xs={12} sm={6}>
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select labelId="tribunal-label" id="Tribunal" value={tribunal} onChange={handleTribunalChange}>
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select labelId="ville-label" id="ville" value={ville} onChange={handleVilleChange}>
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select labelId="Matière-label" id="Matière" value={Matière} onChange={handleMatièreChange}>
