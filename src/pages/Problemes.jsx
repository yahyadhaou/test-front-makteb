...
const TABLE_HEAD = [
  ...
  { id: 'conclusion', label: 'الفرض', alignRight: false },
  { id: 'Datedelaudience', label: 'ت.الجلسة', alignRight: false },
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, numeroDossier, demandeur, nomdedemandeur, Tribunal, ville, Matière, T, nuLecas, Datedelaudience,conclusion } = row;
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left"  style={{ fontSize: '18px' }}>{conclusion}</TableCell>
                        <TableCell align="left" style={{ fontSize: '18px' }} >{Datedelaudience.slice(0, 10)}</TableCell>
